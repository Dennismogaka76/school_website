...
nav ul li:hover ul li{
	display: block;
		...
		article{width: 70%;margin-left: 15%;border:2px solid green;border-radius: 10px;}
...
<ul>
						...
						</li></ul></ul></nav><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
<article>
	<section>

		<p>The school has two deputy principals:
			<ul style="font-size: 22px;">
				<li>Deputy principal- administration</li>
				<li>Deputy principal- academics</li>
			</ul></p>
			
			<h4>Deputy principal- administration</h4>
			<img src="images/deputyadmin.jpg">
			<p>
				The deputy principal in charge of administration is Mr.Munika Patrick,he is a mathematics teacher.he ensures the day to day running of the school.he has worked to maintain very high standards of discipline in the school.
			</p>
				<h4>Deputy principal- administration</h4>
				<img src="images/deputyacademics.jpg">
			<p>
				The deputy principal in charge of academics is Mr.Bernad Wamalwa,he is a physics teacher.He ensures that students and teachers have a condusive environment for studies.he has worked to maintain the good perfomance of the school.
			</p>
